...
<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			selectComCombo("cli", "cilall", "all", "", "");  // 거래처  cilall : selectbox ID   value :  supNo
			selectComCombo("pro", "proall", "sel", "", ""); // 제품정보  proall : selectbox ID   value :  prodNo
			selectComCombo("whp", "whpall", "all", "", ""); // 창고관리자  whpall : selectbox ID   value :  loginID
						        ...
						        <table>
								    <tbody>
								          <tr>
								               ...
								               <td><b><h6>거래처</h6></b></td>
								               <td>
								                       <select id="cilall"  name="cilall" > </select>
								               </td>
								               <td><b><h6>창고관리자</h6></b></td>
								               <td>
