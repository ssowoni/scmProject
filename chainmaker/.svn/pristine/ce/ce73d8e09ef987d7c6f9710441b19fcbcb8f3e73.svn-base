...
<script type="text/javascript">
	 ...
	 */
					...
					<div id="lnb_area">
						<div class="logo">
									<div id="header">
			                            <a class="logo" href="/dashboard/dashboard.do">
			                                <img src="/images/admin/comm/happy.jpg" alt="메인페이지"  width="80%" height="55px" /></a>
		                           </div>
						</div>
						
						<div class="login">
								<img src="/images/admin/comm/left_myImg.jpg" class="LoginImg" alt="사진" /> <span
									class="LoginName">${sessionScope.userNm}</span>
